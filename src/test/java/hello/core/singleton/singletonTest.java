...
public class singletonTest {
    ...
    void springContainer() {
        ...
        //1. 조회 : 호출할 때 마다 객체를 생성
        MemberService memberSevice1 = ac.getBean("memberService",MemberService.class);
        MemberService memberSevice2 = ac.getBean("memberService",MemberService.class);
        //참조값이 같은것을 확인
        System.out.println("memberService1: " + memberSevice1);
        System.out.println("memberService2: " + memberSevice2);

        //memberService 1 은 memberService랑 같음
        assertThat(memberSevice1).isSameAs(memberSevice2);
    }
